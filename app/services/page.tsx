...
<div className="svc-visual reveal"><img className="svc-photo" src="/images/laptop-motherboard-chip-level-repair-mumbai.jpg" alt="Orbit IT Solutions technician performing chip-level repair on an opened laptop motherboard" loading="lazy" /><div className="grad g-laptop"></div><svg className="ring" viewBox="0 0 400 400" aria-hidden="true"><g fill="none" strokeWidth="1"><circle cx="200" cy="200" r="90" stroke="#2E97FF" opacity=".5" /><circle cx="200" cy="200" r="140" stroke="#FF9933" opacity=".3" /><circle cx="200" cy="200" r="185" stroke="#fff" opacity=".12" /></g></svg><span className="tag">Laptop &amp; Desktop</span><svg className="art" viewBox="0 0 200 200" aria-hidden="true"><g fill="none" stroke="#fff" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round"><rect x="45" y="50" width="110" height="72" rx="6" /><path d="M32 122h136l12 20H20z" /><circle cx="100" cy="86" r="20" stroke="#2E97FF" /><path d="M100 76v10l7 7" stroke="#FF9933" /></g></svg></div>
...
<div className="svc-visual reveal"><img className="svc-photo" src="/images/hikvision-video-door-phone-outdoor-unit.jpg" alt="Hikvision video door phone outdoor unit installed by Orbit IT Solutions" loading="lazy" /><div className="grad g-cctv"></div><svg className="ring" viewBox="0 0 400 400" aria-hidden="true"><g fill="none" strokeWidth="1"><circle cx="200" cy="200" r="90" stroke="#2E97FF" opacity=".5" /><circle cx="200" cy="200" r="140" stroke="#FF9933" opacity=".3" /><circle cx="200" cy="200" r="185" stroke="#fff" opacity=".12" /></g></svg><span className="tag">CCTV &amp; Security</span><svg className="art" viewBox="0 0 200 200" aria-hidden="true"><g fill="none" stroke="#fff" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round"><rect x="40" y="74" width="80" height="44" rx="10" /><circle cx="62" cy="96" r="11" stroke="#2E97FF" /><path d="M120 84l44-20M120 108l44 20" /><circle cx="170" cy="60" r="7" stroke="#FF9933" /><path d="M70 118v22M55 140h45" /></g></svg></div>
