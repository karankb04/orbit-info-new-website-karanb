...
import { BrandLogo } from "@/components/BrandRow";
...
<h1>{yearsInBusiness} years in Mumbai. <span className="grad">Still around you.</span></h1>
...
<p>{yearsInBusiness} years later, the work is bigger — CCTV across whole societies, backup for entire offices, Tally for businesses that have outgrown their spreadsheets. But it&rsquo;s still the same idea: be local, be fast, and actually fix the thing.</p>
...
<div className="cert-grid"><div className="cert reveal"><span className="ribbon"></span><div className="cert-logo"><BrandLogo brand={BRANDS.synology} className="cert-logo-img" /></div><h3>Synology</h3><p>Authorized Partner</p></div><div className="cert reveal"><span className="ribbon"></span><div className="cert-logo"><BrandLogo brand={BRANDS.tally} className="cert-logo-img" /></div><h3>Tally</h3><p>Certified Partner</p></div><div className="cert reveal"><span className="ribbon"></span><div className="cert-logo"><BrandLogo brand={BRANDS.cpPlus} className="cert-logo-img" /></div><h3>CP Plus</h3><p>CCTV Channel Partner</p></div><div className="cert reveal"><span className="ribbon"></span><div className="cert-logo"><BrandLogo brand={BRANDS.hikvision} className="cert-logo-img" /></div><h3>Hikvision</h3><p>Installation Partner</p></div></div></div></section>

<section className="values"><div className="wrap"><div className="sec-head light reveal"><span className="eyebrow on-light">How we work</span><h2>Three rules. {yearsInBusiness} years.</h2></div>
...
<div className="wrap band-inner"><h2>Let&rsquo;s add your business<br /><span className="grad">to the next {yearsInBusiness} years.</span></h2><p>Whatever&rsquo;s on your desk — broken, slow, or not yet backed up — we&rsquo;re around you.</p>
